...
export default function Login() {
    ...
    return (
        <div className="relative flex h-screen w-screen items-center justify-center overflow-hidden bg-black transform scale-150">
            {/* Ajustement de l'arrière-plan avec des étoiles */}
            ...
            >
                <motion.div
                    className="relative p-8 bg-[rgba(16,19,231,0.2)] backdrop-blur-lg border border-white/30 rounded-2xl shadow-xl"
                    whileHover={{ scale: 1.02 }}
                    transition={{ duration: 0.2 }}
                >
                    {/* Effet de contour lumineux */}
                    <div className="absolute inset-0 pointer-events-none bg-gradient-to-r from-transparent via-white to-transparent opacity-20 rounded-2xl blur-lg" />
                    ...
                    >
                        <Image
                            ...
                            className="w-auto h-16 object-contain logo"
                        />
                    </motion.div>
