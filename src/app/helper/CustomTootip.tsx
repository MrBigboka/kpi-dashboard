        ...
        <PopoverContent className="w-80">
          <div className="grid gap-4">
            <div className="space-y-2">
              <h4 className="font-medium leading-none">Détails pour {label}</h4>
              <p className="text-sm text-muted-foreground">
                Voici un aperçu détaillé des économies réalisées ce mois-ci.
              </p>
            </div>
            <div className="grid gap-2">
              <div className="grid grid-cols-2 items-center gap-4">
                <span className="text-sm">Économies totales:</span>
              ...
              <div className="grid grid-cols-2 items-center gap-4">
                ...
                <span className="font-medium">{timeSaved} minutes</span>
              </div>
              <div className="grid grid-cols-2 items-center gap-4">
