    ...
    const companies = [
        {
            value: "smartscaling",
            name: "SmartScaling",
            logo: "/smartscaling2.png",
        },
        { value: "gestrago", name: "Gestrago", logo: "/gestrago.jpg" },
    ];

    return (
        <header className="flex items-center justify-between p-4 bg-background shadow-lg border-b border-gray-200 dark:border-gray-700">
